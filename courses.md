...
* Intended to be a quick start in ML. 
* Teaches us how to use popular algorithms in Regression, Classification, Clustering and Recommender Systems using Graphlab Create.

The rest of the courses in the series will cover how to achieve the same results from scratch using Python.
